        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <a href="/new-motorcycles">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">New Motorcycles</h2>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <a href="/used-motorcycles">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Used Motorcycles</h2>
                </div>
            </a>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <a href="/repairs-and-maintenance">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><i class="fas fa-exchange-alt"></i></div>
                    <h2 class="h5 mt-4 text-center">Repairs & Maintenance</h2>
                </div>
            </a>
        </div>
